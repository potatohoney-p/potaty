...
package com.potaty.graphics.bitmap

import com.potaty.common.Characters.TRANSPARENT_CHAR
import com.potaty.common.Characters.isHalfTransparent
import com.potaty.common.Characters.isTransparent
import com.potaty.common.Characters.isWideContinuation
import com.potaty.graphics.bitmap.PotatyBitmap.Builder
 ...
 */
class PotatyBitmap private constructor(val matrix: List<Row>) {
    val size: Size = Size(
    ...
    class Builder(private val width: Int, private val height: Int) {
        ...
        fun fill(row: Int, column: Int, bitmap: PotatyBitmap) {
            if (bitmap.isEmpty()) {
                return
            }
    ...
    class Row internal constructor(visualChars: List<Char>, directionChars: List<Char>) {
        ...
        override fun toString(): String {
            ...
            return list.joinToString("") { char ->
                if (char.isWideContinuation) "" else char.toString()
            }
        }
    }
