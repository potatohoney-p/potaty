...
import com.potaty.graphics.board.CrossingResources.hasBottom
import com.potaty.graphics.board.CrossingResources.hasLeft
import com.potaty.graphics.board.CrossingResources.hasRight
import com.potaty.graphics.board.CrossingResources.hasTop
import com.potaty.graphics.board.CrossingResources.inDirectionMark
 ...
 */
class PotatyBoard(private val unitSize: Size = STANDARD_UNIT_SIZE) {
    ...
    fun fill(position: Point, bitmap: PotatyBitmap, highlight: Highlight) {
